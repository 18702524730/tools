      ...
      <ul class="resultlists">
        ...
        <li class="itemCon" v-for="(item, index) in myResult.list">
          <div class="c48">
            ...
            <a target="_blank" class="mr consult" href="http://pct.zoosnet.net/LR/Chatpre.aspx?id=PCT70172520&lng=cn&p=http://tools.ipsebe.com/tools/pages/oneTouchName.html">注册咨询</a>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      apiUrl:'./NameRecommendCorl/savaShopRecords.do'
    }
  },
  components: {},
  updated () {
  ...
  methods: {
    ...
    selfQuery(item){
      ...
      console.log(item)
      // window.location = "http://localhost:8083/pages/search.html?keyword=" + item;
...
.resultBody{width: 1170px;margin: 0 auto;margin-top: 30px;}
...
.resultlists li:first-child{border-bottom: none;}
.itemCon{margin: 0;width: 100%;height: 40px;padding: 10px 0;text-align: left;border-bottom: 1px solid #eaeaea;}
.img-lb{float: left;}
.c48{width: 1170px;line-height: 39px;height: 39px;vertical-align: middle;}
.name{color: #ff7019;}
.c48 .mr{float: left;width: 24%;display: inline-block;text-align: center;}
.banner{color: #000;background-color: #f2f2f2;height: 45px;line-height: 45px;}
.mr .highlight{color: red;}
.consult,.selfQuery{cursor: pointer;color: #3db1fa}
.effect{font-family: myFirstFont;color: #565656;font-size: 28px;color:#565656;font-weight: 700;}
